...
input_file_1 = 'No3_2020_check090622.csv'
input_file_2 = 'NO3_zonal_statistics.csv'
output_file = 'Python_data_processing_output/no3_Conc_Comparison.csv'
output_false_file = 'Python_data_processing_output/no3_FALSE_Conc_Values.csv'
