...
output_headers = ['Total Row Count', 'Over 1 Percent', 'Over 2.5 Percent', 'Over 5 Percent', 'Over 10 Percent','Over 25 Percent', 'Over 50 Percent']
...
df_calcs = pd.DataFrame(Percents, columns = output_headers)
